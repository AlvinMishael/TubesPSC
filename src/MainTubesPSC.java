...
public class MainTubesPSC {
    public static void main(String[] args) {
        ...
        int ukuranPopulasi = sc.nextInt();      //input untuk menentukan ukuran populasi yang
        System.out.print("Ukuran tabel: ");
        int panjangTabel = sc.nextInt(); //Menginisialisi panjangTabel dengan kuadrat dari input, karena untuk memetakan array 2 dimensi ke 1 dimensi maka panjang tabel 1 dimensi merupakan kuadrat dari
        ...
        int totalAngkaTabel =0; //variable ini digunakan untuk menghitung kotak yang terisi angka (tidak kosong)
        for(int i =0; i < panjangTabel; i++){ //memasukkan tabel mineswipper
            tabel[i] = sc.nextInt();
            if(tabel[i] != -1){ //setiap ada input kotak yang berisi angka
